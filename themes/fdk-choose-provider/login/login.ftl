            ...
            <div class="row">
                <div class="col-xs-12">
                    <p>
                        ...
                        Du kan få tilgang eller gi andre tilgang til å registrere datasettbeskrivelser, API-beskrivelser, begreper og behandlingsaktiviteter, og administrere høsting
