...
echo "DATASERVICE_CATALOG_GUI_HOST=$DATASERVICE_CATALOG_GUI_HOST"
echo "TERMS_AND_CONDITIONS_GUI_HOST=$TERMS_AND_CONDITIONS_GUI_HOST"
...
sed -e 's,${IDPORTEN_CLIENT_ID},'$IDPORTEN_CLIENT_ID',g' \
 ...
 -e 's,${FDK_COMMUNITY_SERVICE_HOST},'$FDK_COMMUNITY_SERVICE_HOST',g' \
 -e 's,${RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST},'$RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST',g' \
 -e 's,${DATASERVICE_CATALOG_GUI_HOST},'$DATASERVICE_CATALOG_GUI_HOST',g' \
 -e 's,${TERMS_AND_CONDITIONS_GUI_HOST},'$TERMS_AND_CONDITIONS_GUI_HOST',g' \
 ...
 -e 's,${DEV_DATASERVICE_CATALOG_GUI_HOST},'$DEV_DATASERVICE_CATALOG_GUI_HOST',g' \
 -e 's,${DEV_TERMS_AND_CONDITIONS_GUI_HOST},'$DEV_TERMS_AND_CONDITIONS_GUI_HOST',g' \
 -e 's,${DEV_FDK_COMMUNITY_SERVICE_HOST},'$DEV_FDK_COMMUNITY_SERVICE_HOST',g' \
 ...
 -e 's,${OK_CLIENT_ID},'$OK_CLIENT_ID',g' \
 -e 's,${OK_CLIENT_SECRET},'$OK_CLIENT_SECRET',g' \
 -e 's,${OK_OIDC_TOKEN_URL},'$OK_OIDC_TOKEN_URL',g' \
 -e 's,${OK_OIDC_AUTHORIZATION_URL},'$OK_OIDC_AUTHORIZATION_URL',g' \
 -e 's,${FDK_CLIENT_SECRET},'$FDK_CLIENT_SECRET',g' \
